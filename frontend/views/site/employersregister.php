							...
							<div class="cols-sm-10">
								<div class="input-group">  
									  <div class="radio float-left-widtth3">
										<label>
										  <input type="radio" value="2" name="AllUser[UserTypeId]" selected>
										  Company
										</label>
									  </div>
									  <div class="radio float-left-widtth3">
										<label>
										  <input type="radio" value="3" name="AllUser[UserTypeId]">
										   Consultancy
										</label>
									  </div> 
								</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" onkeypress="return numbersonly(event)" onblur="return IsMobileno(this.value);" class="form-control" required name="AllUser[MobileNo]" id="MobileNo"  placeholder="Mobile No"/>
								</div>
							</div>
						</div> 
