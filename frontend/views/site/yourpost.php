                            ...
                            <div class="widget">
                                ...
                                <ul class="short-decs-sidebar">
                                    <li>
                                        <div>
                                            <h4>Job Type:</h4></div>
                                        <div><i class="fa fa-bars"></i>Part Time </div>
                                    </li>
                                    <li>
                                        <div>
                                            <h4>Job Experience:</h4></div>
                                        <div><i class="fa fa-clock-o"></i>5 years</div>
                                    </li>
                                    <li>
                                        <div>
                                            <h4>Job Shift:</h4></div>
                                        <div><i class="fa fa-calendar"></i>Morning </div>
                                    </li>
                                    <li>
                                        <div>
                                            <h4>Posted On:</h4></div>
                                        <div><i class="fa fa-calendar"></i>10 May, 2016 </div>
                                    </li>
                                    <li>
                                        <div>
                                            <h4>Location:</h4></div>
                                        <div><i class="fa fa-location-arrow"></i>Ratigan, Vatnaam </div>
                                    </li>
                                    <li>
                                        <div>
                                            <h4>Expected Salary:</h4></div>
                                        <div><i class="fa fa-dollar"></i>600/month </div>
                                    </li>
                                </ul>
                            </div>
                            <div class="apply-job">
                                    <a class="" href=""> <i class="fa fa-upload"></i>Apply For Position</a>
                                  </div> 
                    </div>
                        <div class="col-lg-9  col-md-8 col-sm-8 col-xs-12">
                            <div class="single-job-page-2 job-short-detail">
                                ...
                                <div class="job-desc job-detail-boxes">
                                    ...
                                    <ul class="desc-points  margin-bottom-20 ">
                                        <li>
